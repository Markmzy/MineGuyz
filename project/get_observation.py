...
def get_observation(world_state, agent_host):
    ...
    while world_state.is_mission_running:
        ...
        if world_state.number_of_observations_since_last_state > 0:
            ...
            grid_binary = [1 if x == 'glass' or x == 'gold_block'  or x == 'emerald_block' or x == 'diamond_block' or x == 'iron_block' or x == 'stone' else -1 if x=='redstone_block' else 0 for x in grid]
